...
\paragraph{Metni kaydetme}{ Metin düzenlediğinde veya giriş yaptığında “\Ctrl + o” kullanarak kaydedebilirsiniz. Nano size dosya için bir isim sorar. (Bölüm ~\ref{chap:bolum6} sonunda dosya isimleri hakkında daha fazlasını göreceğiz.) Nano daha sonra dosya ismiyle metni kaydeder.}
