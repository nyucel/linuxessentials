...
\begin{itemize}
 ...
 \item Temel Özgür ve Açık Kaynak Kodlu Yazılım lisanslarını öğrenmek
...
\begin{itemize}
 \item Bilgisayarlar ve işletim sistemleri hakkında temel bilgiler (Bölüm ~\ref{chap:bolum1})
 \end{itemize}
\begin{section}{Linux: Bir Başarı Öyküsü}

Linux Torvalds\footnote{Linus Torvalds, etnik olarak bir Fin 'dir.(2010 'un Eylül ayında Amerikan vatandaşı olmuştur.) İsveççe konuşan bir azınlığın üyesidir. Kolayca telafuz edilebilen bir isme sahip olmasının nedeni budur.}, 1991 'in yazında, daha 21 yaşındayken Finlandiya Helsinki Teknik Üniversitesi 'nin bilgisayar bilimleri bölümünde öğrenim görüyordu. O zamanlar, yeni 386 'sı ile denemeler yapmak istiyordu ve işletim sistemi olmadan direk donanım üzerinde çalışan bir terminal emülatörü yazarak (Bu ona üniversitesindeki Unix sistemine erişimini sağlamıştı) kendisini oyalıyordu.  Bu program zamanla ilk Linux işletim sistemi çekirdeğine dönüştü.
...
Linux’un ilk versiyonunu geliştirmek için Linus, Minix’ten yararlandı. Minix Amsterdam Özgür Üniversitesindeki Andrew S. Tanenbaum tarafından öğretim amaçlı yazılmış bir sistemdir. Minix küçük tutulmuştu ve özgürce ulaşılabilir değildi. Bu yüzden ciddi bir işletim sistemi olarak tanınmamıştır\footnote{BSD zamanında özgürce kullanılabilir değildi. Ozamanlar kolayca erişilebilir olsaydı, belkide Linux 'a hiç başlanmamış olacaktı.}.

25 Ağustus 1991’ de Linus projesini herkese duyurdu ve dünyanın kalanını katılması için davet etti. Proje, Minix için alternetif bir işletim sistemi çekirdeği olarak görev yaptı.
...
Linux dikkate değer bir ilgiyi ve yardım edecek çok fazla gönüllü buldu. Linux 0.99 Aralık 1992'de GPL'nin ilk versiyonu altında lisanslandı ve Unix işlevselliğine sahip kullanılabilir bir işletim sistemi olmuş oldu.
...
Bir diğer önemli değişiklik ise, Linux' un maskotu penguen "Tux" oldu.  Linus Torvalds Avustralya' da bir penguenle karşılaşmış ve bundan çok etkilenmişti. Sarı ayakları ve gagasıyla oturan simgesel penguen Larry Ewing tarafından çizilmiş ve camiaya sunulmuştur.
...
\footnote{Stallman 'ın örgütü, Özgür Yazılım Vakfı şöyle bir tanım yapıyor; "Free as in speech, not as in beer"} yapamadığı çeşitli şeyleri yapabilir. RMS yazılım paketini "Özgür" olarak adlandırmak için 4 şart arar. "Dört Özgürlük" ile tanışın:
...
GPL'e ek olarak, başka popüler diğer lisanslarda vardır. Işte kısa bir bakış:
...
\footnote{Örneğin, Windows 8 beta yerine Ubuntu kurup, gerekli kişiselleştirmeleri yapabilirseniz, kullanıcıyı gerçekten onun Windows 8 beta olduğuna ikna edebilirsiniz.} kullanıcılar farkı görmeyebilir bile.
