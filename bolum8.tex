...
Girdilerini standart girdiden alıp çıktılarını standart çıktıya veren araçlara “filtre komutları” ya da kısaca “filtreler” denir. Girdi yönlendirmesi olmadan bir filtre girdisini klavyeden okuyabilir. Klavye girişinin bittiğini belirtmek için terminal tarafından “dosya sonu” olarak algılanılan \Ctrl + \keystroke{d} tuş kombinasyonunu kullanmalısınız.

Bunun sadece klavye girdisi için uygulanabildiğini unutmayın. Diskteki dosya doğal olarak \Ctrl + \keystroke{d} karakterini (ASCII 4) içerebilir ve sistem bunun dosyanın sonu olduğunu düşünmez.
